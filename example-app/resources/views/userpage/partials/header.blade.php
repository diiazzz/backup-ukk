    ...
    <div class="row align-items-center py-3 px-xl-5">
        <div class="col-lg-3 d-none d-lg-block">
            <a href="" class="text-decoration-none">
                <h1 class="m-0 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold ">D'</span>mecrame</h1>
            </a>
        </div>
        ...
        <div class="col-lg-3 d-none d-lg-block">
            ...
            <nav class="collapse navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical">
                <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                    ...
                    <a href="" class="nav-item nav-link">mini</a>
                    <a href="" class="nav-item nav-link">sedang</a>
                    <a href="" class="nav-item nav-link">besar</a>
                    <a href="" class="nav-item nav-link">super jumbo</a>
